...
var FBXLoader = ( function () {
	...
	FBXTreeParser.prototype = {
		...
		getTransformData: function ( model, modelNode ) {
			console.log(model.name,modelNode.RotationOrder?.value);
			var transformData = {};
	...
	AnimationParser.prototype = {
		...
		generateRotationTrack: function ( modelName, curves, initialValue, preRotation, postRotation, eulerOrder ) {
			console.log(modelName,initialValue[3]);
			if(modelName == "frontRump_R"){
				initialValue[3] = eulerOrder = "YZX";
			}
			if(modelName == "frontRump_L"){
				initialValue[3] = eulerOrder = "ZXY";
			}
